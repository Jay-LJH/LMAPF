...
class MazeEnv(gym.Env):
    ...
    def add_agents(self, agents_state: list):
        self.maze_view.agents_states = agents_state
    ...
    def set_goal(self, new_target: np.array):
        self.maze_view.set_goal(new_target)
...
class MazeEnvSample100x100(MazeEnv):
    ...
    def __init__(self, enable_render=True):
        super(MazeEnvSample100x100,
              self).__init__(maze_file="maze2d_100x100.npy",
                             enable_render=enable_render)
...
class MazeEnvRandom10x10Plus(MazeEnv):
    ...
    def __init__(self, enable_render=True):
        super(MazeEnvRandom10x10Plus,
              self).__init__(maze_size=(10, 10),
                             mode="plus",
                             enable_render=enable_render)
...
class MazeEnvRandom20x20Plus(MazeEnv):
    ...
    def __init__(self, enable_render=True):
        super(MazeEnvRandom20x20Plus,
              self).__init__(maze_size=(20, 20),
                             mode="plus",
                             enable_render=enable_render)
...
class MazeEnvRandom30x30Plus(MazeEnv):
    ...
    def __init__(self, enable_render=True):
        super(MazeEnvRandom30x30Plus,
              self).__init__(maze_size=(30, 30),
                             mode="plus",
                             enable_render=enable_render)
