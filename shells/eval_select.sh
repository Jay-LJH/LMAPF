...
python eval_rl_select.py "$@" all 1.0| tee -a logs/eval_select.txt
python eval_rl_select.py "$@" random 0.5| tee -a logs/eval_select.txt
python eval_rl_select.py "$@" pibt 0.5| tee -a logs/eval_select.txt
python eval_rl_select.py "$@" BC 0.5 | tee -a logs/eval_select.txt